...
export default function ServiceCards() {
  ...
  const cards = [
    {
      tag: t('serviceCards.compassionateCare'),
      title: t('serviceCards.compassionateCare'),
      description: t('serviceCards.compassionateDescription'),
      image: "/images/patient1.png"
    },
    {
      tag: t('serviceCards.premiumElderCare'),
      title: t('serviceCards.premiumElderCare'),
      description: t('serviceCards.premiumElderCareDescription'),
      secondaryText: t('serviceCards.premiumElderCareSecondary'),
      image: "/images/old-lady.jpg"
    }
  ];
      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 pr-0 lg:pr-6">
            <div className="inline-block">
              <Link href="/about" className="inline-flex items-center justify-center px-4 py-2 rounded-full border border-neutral-300 text-neutral-700 hover:bg-neutral-50 transition-colors mb-6">
                {t('serviceCards.aboutUs')}
              </Link>
            </div>
            
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 mb-4 space-y-2">
              {t('serviceCards.experience')}<br />
              {t('serviceCards.nursingServices')}<br />
              <span className="text-primary-400">{t('serviceCards.bureau')}</span><br />
              <span className="text-primary-400">{t('serviceCards.bureau2')}</span>
            </h2>
            ...
            <Link 
              ...
              className="inline-flex items-center px-6 py-3 bg-primary-400 text-white rounded-full hover:bg-primary-500 transition-colors"
            >
              <span>{t('serviceCards.connectWithUs')}</span>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
            </Link>
