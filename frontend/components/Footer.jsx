        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-12">
          ...
          <div>
            ...
            <p className="text-neutral-300 mb-8 max-w-md">
              We provide professional nursing facilities to hospitals and offer personal care for elderly patients at home throughout Pune and Maharashtra, including skilled doctors, nurses, caretakers, and other healthcare services.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-neutral-300">
                ...
                <span>support@jayshankarnursingbureau.com</span>
              </div>
              ...
              <div className="flex items-center text-neutral-300">
                ...
                <span>123 Koregaon Park, Pune, Maharashtra 411001, India</span>
              </div>
            </div>
          </div>
          ...
          <div className="md:ml-auto">
            ...
            <nav className="flex flex-col space-y-3">
              ...
              <Link href="/service-areas" className="text-neutral-300 hover:text-blue-400 transition-colors">
                Service Areas
              </Link>
            </nav>
          </div>
          ...
          <div>
            ...
            {/* Service Areas */}
            <div className="mt-8">
              <h3 className="text-white text-lg font-semibold mb-4">Service Areas in Pune</h3>
