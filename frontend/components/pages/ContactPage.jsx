...
//                     <a href="mailto:jayshankarnursingbureau@gmail.com" className="text-blue-500 font-medium hover:text-blue-700">jayshankarnursingbureau@gmail.com</a>
//                   </div>
//                 </div>
...
//               <a href="tel:+919049852645" className="inline-flex items-center px-6 py-3 bg-blue-500 text-white rounded-full font-medium hover:bg-blue-600 transition-colors">
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store preview URL if available (for testing)
      if (data.previewUrl) {
    ...
    <>
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className={`w-full py-3 px-6 rounded-lg text-white font-medium ${loading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
                        } transition-colors`}
                    >
                      {loading ? t('contactForm.sendingButton') : t('contactForm.sendButton')}
                    </button>
      ...
      <section className="py-12 bg-white">
        <div className="container-custom">
          ...
          {/* Map Embed (updated to Warje Malwadi, NDA Road location) */}
          <div className="h-96 bg-neutral-200 rounded-lg overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3783.8768783367897!2d73.7899859!3d18.470577!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc295aee1ed17c1%3A0xf2c61a2bfe8d7a20!2sWarje%20Malwadi%2C%20NDA%20Rd%2C%20Pune%2C%20Maharashtra%20411052!5e0!3m2!1sen!2sin!4v1716074301635!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
